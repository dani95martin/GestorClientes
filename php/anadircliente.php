...
$sql2 = "INSERT INTO clientes(nombre_fiscal, nif, numero_cuenta_banco, persona_contacto, telefono, email, email2, direccion, horario, web, facebook, twitter, instagram, observaciones, imagen)";
$sql2.= "VALUES ('$nombreFiscal', '$nif', '$cuentabanco', '$personaContacto', '$telefono', '$email', '$email2', '$direccion', '$horario', '$paginaweb', '$facebook', '$twitter', '$instagram', '$observaciones', '$urlfoto')";
